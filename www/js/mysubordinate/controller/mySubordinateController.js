angular.module('member.mySubordinateController2', [])

  .controller('MySubordinateCtl2', function ($scope,
                                            $ionicScrollDelegate,
                                            $timeout,
                                            $ionicLoading,
    ...
    $scope.contentUrl = 'js/mysubordinate/templates/mySubordinateScore.html';
    ...
    $scope.seeSubordinateState = function () {
      ...
      $scope.noActive = true;
      $scope.contentUrl = 'js/mysubordinate/templates/mySubordinateState.html';
    };
